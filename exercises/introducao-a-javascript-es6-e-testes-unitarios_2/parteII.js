...
const pegaValorPeloNumero = (obj, number) => console.log(Object.values(obj)[number]);

// 8 - Crie uma função que verifique se o par (chave / valor) existe na função. Essa função deve possuir três parâmetros, sendo eles: o objeto, o nome da chave e o valor da chave. Exemplo:
const verificaPar = (obj, nomeChave, valorChave) => {
    if(Object.keys(obj).includes(nomeChave) && Object.values(obj).includes(valorChave)) {return true;}
    else {return false;}
}
